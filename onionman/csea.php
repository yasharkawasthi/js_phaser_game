...
<head>
    <meta charset="UTF-8" />
    <title>Level-2 -- <?php echo htmlspecialchars($_SESSION["gamingname"]); ?></title>
...
<body>
<a href="csea.php" onclick="location.href='home.php';return false;">Home Screen</a>
<a href="csea.php" onclick="location.href='logout.php';return false;" style="float:right;">Log Out</a>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
function checkWin (player, shutdoor)
{
    if(stars.countActive(true) === 0)
    {
        ...
        score=score+health+(life*100)+300;
